import { Agent, type AgentEvent } from "@mrquake/quakecode-agent-core";
import { getModel, type ImageContent } from "@mrquake/quakecode-ai";
import {
	AgentSession,
	AuthStorage,
...
async function _getAnthropicApiKey(authStorage: AuthStorage): Promise<string> {
...
function createRunner(sandboxConfig: SandboxConfig, channelId: string, channelDir: string): AgentRunner {
	...
	// Create agent
	const agent = new Agent({ sessionId: "mom-session" });
