...
// ============================================================================
// OAuth API key resolution from ~/.quake-code/agent/auth.json
// ============================================================================
...
/**
 * Resolve API key for a provider from ~/.quake-code/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.quake-code/agent/auth.json
 */
...
/**
 * Get an AuthStorage instance backed by ~/.quake-code/agent/auth.json
