...
export default function (quake: ExtensionAPI) {
	...
	quake.registerCommand("overlay-animation", {
	...
	quake.registerCommand("overlay-anchors", {
	...
	quake.registerCommand("overlay-margins", {
	...
	quake.registerCommand("overlay-stack", {
	...
	quake.registerCommand("overlay-overflow", {
	...
	quake.registerCommand("overlay-edge", {
	...
	quake.registerCommand("overlay-percent", {
	...
	// Test maxHeight
	quake.registerCommand("overlay-maxheight", {
	...
	quake.registerCommand("overlay-sidepanel", {
	...
	quake.registerCommand("overlay-toggle", {
	...
	quake.registerCommand("overlay-passive", {
	...
	quake.registerCommand("overlay-focus", {
	...
	quake.registerCommand("overlay-streaming", {
	...
	private startProcess(): void {
		...
		this.proc = spawn("bash", [
			...
			for i in $(seq 1 100); do
				...
				DIR="/Users/nicobailon/Documents/development/quake-code/packages/coding-agent/src/modes/interactive"
				...
				if [ $((i % 5)) -eq 0 ]; then
					echo -e "  \\033[32m✓ Successfully processed \${i} files in /Users/nicobailon/Documents/development/quake-code\\033[0m"
				fi
				if [ $((i % 7)) -eq 0 ]; then
