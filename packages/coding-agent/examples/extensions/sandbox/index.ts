 ...
 * - ~/.quake-code/agent/sandbox.json (global)
 ...
 *
 * Setup:
 * 1. Copy sandbox/ directory to ~/.quake-code/agent/extensions/
 * 2. Run `npm install` in ~/.quake-code/agent/extensions/sandbox/
 *
