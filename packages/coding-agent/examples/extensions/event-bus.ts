 ...
 *
 * Shows quake.events for communication between extensions. One extension
...
export default function (quake: ExtensionAPI) {
	...
	quake.events.on("my:notification", (data) => {
