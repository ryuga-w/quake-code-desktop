...
export interface ExtensionUIContext {
	...
	/** Show Codex-compatible structured user-input questions. */
	requestUserInput?(request: RequestUserInputArgs): Promise<RequestUserInputResponse | undefined>;
	...
	/** Set a right sidebar panel. Hidden automatically on narrow terminals. */
	setSidebar(key: string, content: string[] | undefined): void;
	setSidebar(key: string, content: ((tui: TUI, theme: Theme) => Component & { dispose?(): void }) | undefined): void;
	 ...
	 * extend `CustomEditor` from `@mrquake/quakecode-cli` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@mrquake/quakecode-cli";
	 *
...
export interface ExtensionContext {
	...
	/** Gracefully shutdown Quake Code and exit. Available in all contexts. */
	shutdown(): void;
	...
	/** Current Codex-compatible collaboration mode. */
	getCollaborationMode(): CollaborationModeKind;
	/** Change the active Codex-compatible collaboration mode. */
...
export interface ExtensionAPI {
	...
	/** Remove a tool previously registered by this extension. */
...
/** Configuration for registering a provider via quake.registerProvider(). */
...
export type ExtensionFactory = (quake: ExtensionAPI) => void | Promise<void>;
...
/**
 * Action implementations for quake.* API methods.
