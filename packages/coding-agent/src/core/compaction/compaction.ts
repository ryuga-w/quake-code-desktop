...
import type { AssistantMessage, Model, Usage } from "@mrquake/quakecode-ai";
import { completeSimple } from "@mrquake/quakecode-ai";
import {
	convertToLlm,
...
import { COMPACT_CHECKPOINT_PROMPT } from "../prompts/codex-templates.js";
import {
	computeFileLists,
	createFileOps,
...
function extractFileOperations(
	...
	// Collect from previous compaction's details (if Quake-generated)
...
const SUMMARIZATION_PROMPT = COMPACT_CHECKPOINT_PROMPT;
