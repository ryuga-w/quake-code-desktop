    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="quake-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="quake-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'quake-share:v1:sidebar-width';
