...
export function printHelp(): void {
	console.log(`${chalk.bold(DISPLAY_NAME)} - AI coding assistant with read, bash, edit, write tools
...
${chalk.bold("Environment Variables:")}
  ...
  NVIDIA_API_KEY                   - NVIDIA models on OpenRouter (optional; else OPENROUTER_API_KEY)
  AI_GATEWAY_API_KEY               - Vercel AI Gateway API key
  ZAI_API_KEY                      - ZAI API key
  MISTRAL_API_KEY                  - Mistral API key
  MINIMAX_API_KEY                  - MiniMax API key
  OPENCODE_API_KEY                 - OpenCode Zen/OpenCode Go API key
  GROK_AUTH_TOKEN                  - Grok JWT (or use ~/.grok/auth.json from grok login)
  ...
  ${ENV_ANTIGRAVITY_VERSION.padEnd(32)} - Override Antigravity User-Agent version (e.g., 1.23.0)
