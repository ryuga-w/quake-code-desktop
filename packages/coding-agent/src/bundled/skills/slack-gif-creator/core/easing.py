...
def ease_in_elastic(t: float) -> float:
    ...
    if t == 0 or t == 1:
        return t
    return -math.pow(2, 10 * (t - 1)) * math.sin((t - 1.1) * 15.707963267948966)
...
def ease_out_elastic(t: float) -> float:
    ...
    if t == 0 or t == 1:
        return t
    return math.pow(2, -10 * t) * math.sin((t - 0.1) * 15.707963267948966) + 1
...
def ease_in_out_elastic(t: float) -> float:
    ...
    t = t * 2 - 1
    if t < 0:
        return -0.5 * math.pow(2, 10 * t) * math.sin((t - 0.1) * 15.707963267948966)
    return math.pow(2, -10 * t) * math.sin((t - 0.1) * 15.707963267948966) * 0.5 + 1
