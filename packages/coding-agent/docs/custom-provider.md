...
Extensions can register custom model providers via `quake.registerProvider()`. This enables:
...
export default function (pi: ExtensionAPI) {
  ...
  quake.registerProvider("my-provider", {
...
Use `quake.unregisterProvider(name)` to remove a provider that was previously registered via `quake.registerProvider(name, ...)`:
...
// Later, remove it
quake.unregisterProvider("my-llm");
```
...
```typescript
quake.registerProvider("custom-api", {
  baseUrl: "https://api.example.com",
  apiKey: "MY_API_KEY",
...
```typescript
import type { OAuthCredentials, OAuthLoginCallbacks } from "@mrquake/quakecode-ai";
...
Credentials are persisted in `~/.quake-code/agent/auth.json`:
...
- [anthropic.ts](https://github.com/mrquakex5/quake-code/blob/main/packages/ai/src/providers/anthropic.ts) - Anthropic Messages API
- [mistral.ts](https://github.com/mrquakex5/quake-code/blob/main/packages/ai/src/providers/mistral.ts) - Mistral Conversations API
- [openai-completions.ts](https://github.com/mrquakex5/quake-code/blob/main/packages/ai/src/providers/openai-completions.ts) - OpenAI Chat Completions
- [openai-responses.ts](https://github.com/mrquakex5/quake-code/blob/main/packages/ai/src/providers/openai-responses.ts) - OpenAI Responses API
- [google.ts](https://github.com/mrquakex5/quake-code/blob/main/packages/ai/src/providers/google.ts) - Google Generative AI
- [amazon-bedrock.ts](https://github.com/mrquakex5/quake-code/blob/main/packages/ai/src/providers/amazon-bedrock.ts) - AWS Bedrock
...
Test your provider against the same test suites used by built-in providers. Copy and adapt these test files from [packages/ai/test/](https://github.com/mrquakex5/quake-code/tree/main/packages/ai/test):
