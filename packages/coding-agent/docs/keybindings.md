...
All keyboard shortcuts can be customized via `~/.quake-code/agent/keybindings.json`. Each action can be bound to one or more keys.
...
Create `~/.quake-code/agent/keybindings.json`:
