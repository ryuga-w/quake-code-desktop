...
- Built-in: `dark`, `light`
- Global: `~/.quake-code/agent/themes/*.json`
...
```bash
mkdir -p ~/.quake-code/agent/themes
vim ~/.quake-code/agent/themes/my-theme.json
```
...
```json
{
  "$schema": "https://raw.githubusercontent.com/badlogic/quake-code/main/packages/coding-agent/src/modes/interactive/theme/theme-schema.json",
  "name": "my-theme",
  "vars": {
    "primary": "#00aaff",
    "secondary": 242
