export declare const MODELS: {
	...
	readonly "google-antigravity": {
		...
		readonly "gemini-3.6-flash-high": {
			id: string;
			name: string;
			api: "google-gemini-cli";
			provider: string;
		...
		readonly "gemini-3.6-flash-medium": {
			id: string;
			name: string;
			api: "google-gemini-cli";
			provider: string;
		...
		readonly "gemini-3.5-flash-extra-low": {
			id: string;
			name: string;
			api: "google-gemini-cli";
			provider: string;
