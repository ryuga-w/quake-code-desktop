...
export const MODELS = {
    ...
    "google-antigravity": {
        ...
        // CCA rejects bare "gemini-3.5-flash" (404). Real IDs from fetchAvailableModels:
        // gemini-3.5-flash-low (Medium), gemini-3.5-flash-extra-low (Low), gemini-3-flash-agent (High).
        "gemini-3.5-flash": {
