...
import { ArrowUp, Box, Check, ChevronRight, FileSpreadsheet, FileText, FileUp, Folder, Hand, LayoutTemplate, Lightbulb, ListTodo, Paperclip, Plus, Presentation, Puzzle, RotateCcw, ShieldAlert, ShieldCheck, Square, Target, X, Sparkles, Bug, TestTube } from "lucide-react";
...
export function ChatComposer({
  ...
  const renderQuickActions = () => {
    ...
    const actions = [
      { label: t("composer.quickActions.explain"), command: "/explain", icon: Sparkles },
      { label: t("composer.quickActions.debug"), command: "/debug", icon: Bug },
      { label: t("composer.quickActions.test"), command: "/test", icon: TestTube },
      { label: t("composer.quickActions.document"), command: "/doc", icon: FileText },
    ];
    return (
      <div className={styles.quickActionsContainer} aria-label={t("composer.quickActions.label")}>
        {actions.map((act) => {
